# K3 Slice 5 r2 — Exact Source Diff (attachment)

**Commit `ccba6b5`** on `feat/sparkplug-b-k3-session-actor` (PR #188). Full unified diff with function context (`git show ccba6b5 -W`) for the two files changed in r2 (actor `PublishGatedAsync` reorder + replay tests).
...
@@ -42,1006 +42,1012 @@ namespace ElpisEdgeConnect.Sinks.SparkplugB.Session;
 /// <summary>
...
@@ -40,605 +40,676 @@ namespace ElpisEdgeConnect.Sinks.SparkplugB.Tests.Session;
