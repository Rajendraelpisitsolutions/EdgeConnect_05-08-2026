# K3 Slice 6 pass 2 r1 — Exact Source Diff (attachment)

**Commit `40d1351`** on `feat/sparkplug-b-k3-session-actor` (PR #188). Full unified diff with function context (`git show 40d1351 -W`) for every file changed in pass-2 r1 (prepare/attempt split + retry predicate + safe Dispose + NDEATH-gated End + tests).
...
@@ -42,1498 +42,1577 @@ namespace ElpisEdgeConnect.Sinks.SparkplugB.Session;
 /// <summary>
...
@@ -36,735 +36,1024 @@ namespace ElpisEdgeConnect.Sinks.SparkplugB.Tests.Session;
