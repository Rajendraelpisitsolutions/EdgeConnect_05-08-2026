...
$env:EDGECONNECT_LICENSE_PATH  = "C:\dev\EdgeConnect\data\dev-license.local.json"
```
...
export EDGECONNECT_LICENSE_PATH="$HOME/code/EdgeConnect/data/dev-license.local.json"
```
