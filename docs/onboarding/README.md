...
- [`dev-license.json`](dev-license.json) — RSA-signed dev license (Enterprise edition, long-validity, customer `DevOnly`). Committed deliberately. See [02-dev-license.md](02-dev-license.md).
