<!--
File:        docs/marketing/elpis-industrial-intelligence-platform-v3.md
...
Version:     v3 (polish + tighten — reality-check pass)
Date:        2026-05-24

Changes from v2:
  - Trimmed to ~1,700 words (from ~1,950) per executive-skim feedback
  - "Why Elpis" bullets reframed outcome-first instead of architecture-first
  - Removed the "How the platform is built" intro sentence (redundant)
  - "How it deploys" trimmed (broker list de-duplicated against connectivity table)
  - "On the roadmap" trimmed (editorial closing sentence removed)
  - "Deploy incrementally" sharpened with explicit "proof of value" framing
  - All bullet sets shortened in prose, none removed structurally

Out of scope for v3 (deferred to future deliverables, per ChatGPT v2 review):
  - Branded SVG architecture diagram (designer pass)
  - Deployment models visual block
  - Industry-specific edition derivatives (CNC, automotive parts, OEM, energy)
  - Executive pitch deck, website messaging architecture, ROI calculator
...
*Elpis Industrial Intelligence Platform — v3, 2026-05-24. EdgeConnect and EREMOS V2 are products of Elpis IT Solutions. Specifications and roadmap items are subject to change; contact us for the current authoritative product status.*
