<!--
File:        docs/marketing/page-industry-defense-spec-v1.md
...
Version:     v1 — DRAFT. Awaiting Pass 1 ChatGPT review (extra anchor-handling
                + regulated-buyer-tone scrutiny per memo §8 / shape-setter v2 §10.3).
Date:        2026-06-06
Status:      DRAFT. IndustryShell instance (defense). Shape inherited from
...
# `/industries/defense` — Page Spec v1 (DRAFT)

> **⚠️ SUPERSEDED — retained as historical reference.** The LOCKED spec is **`page-industry-defense-spec-v2.md`** (Pass-1 edit: removed "defense-ministry" qualifier from the §3.3 E-IDOS line; anchor remains the entire proof).
...
## 8. Sign-off checklist (v1 DRAFT — awaiting ChatGPT Pass 1, extra anchor scrutiny)
...
- [ ] ChatGPT Pass 1 review (extra anchor-handling + regulated-buyer-tone scrutiny per memo §8) — PENDING → v2 lock
