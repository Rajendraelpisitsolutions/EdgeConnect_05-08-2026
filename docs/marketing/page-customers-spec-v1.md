<!--
File:        docs/marketing/page-customers-spec-v1.md
...
Version:     v1 — DRAFT (pre ChatGPT review, EXTRA anchor + anonymity scrutiny). NOT locked.
Date:        2026-06-06
...
# `/customers` — Page Spec v1 (DRAFT) · CaseStudyShell shape-setter (anonymized)

> **⚠️ SUPERSEDED — retained as historical reference.** The LOCKED spec is **`page-customers-spec-v2.md`** (Pass-1 anchor cleanups: meta description de-paraphrased, Pattern C anchor parenthetical removed, Card 1 tightened to confidentiality-only).
...
| **Meta description** (140-160) | *Deployed in defense and space-agency programs and with AMC providers across India and the Middle East. Anonymized deployment patterns — specifics held in confidence.* |
...
> |---|---|---|
> | 1 | **Deployed in defense and space-agency programs.** | High-consequence programs where reliability is non-negotiable. The customers, programs, and agencies stay off the record — permanently — and that's the point: we hold confidence the way these environments require. |
...
> CONTEXT: A maintenance / AMC provider delivering reliability services on a customer's rotating equipment and hydraulic systems. (Anchor: AMC providers across India and the Middle East.)
