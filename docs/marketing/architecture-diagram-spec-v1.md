<!--
File:        docs/marketing/architecture-diagram-spec-v1.md
...
# Architecture Diagram — Design Spec v1
...
Pick the option that reads cleanest at the smallest intended size (pitch deck slide 16:9 at projection scale).
...
## 9. Output variants and dimensions
...
## 12. Reference: the structural source
...
## 13. Sign-off checklist (before declaring done)
...
- [ ] Diagram is legible at pitch-deck-projection scale (test by exporting at 3200×1800 and viewing at 50%)
- [ ] No anti-patterns from §11 present
- [ ] SVG file size is reasonable (under 500 KB for the master)
- [ ] PNG fallbacks generated at the resolutions in §9
...
- `architecture-diagram-master.svg` — full version
- `architecture-diagram-master-2x.png` — datasheet web fallback
- `architecture-diagram-slide-16x9.svg` — pitch deck variant
- `architecture-diagram-simple.svg` — 3-box executive variant
...
*Architecture Diagram Spec — v1, 2026-05-24. Pair with datasheet v3 Mermaid for structural truth.*
