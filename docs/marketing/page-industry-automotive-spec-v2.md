<!--
File:        docs/marketing/page-industry-automotive-spec-v2.md
...
Date:        2026-06-06
Status:      LOCKED. Second IndustryShell instance (after the Heavy Manufacturing
             shape-setter). Inherits the v2 §10 shape verbatim.

v1 (page-industry-automotive-spec-v1.md) retained as historical reference.
v1 -> v2: no content changes — ChatGPT Pass 1 approved automotive for lock
as-is (faithful shape inheritance, 4 solution cards + 5 FAQ, protocol status
preserved, category-level proof + verbatim geography anchor, no defense anchor).

§9 ACCEPTANCE GATE (phase3 memo v2 §9) — pre-checked in §7.
Word-count target: ~1,000-1,400 words page copy. Current: ~1,210 words.
-->

# `/industries/automotive` — Page Spec v2 (LOCKED)
...
- [x] ChatGPT Pass 1 review — approved with no edits; v2 LOCKED
