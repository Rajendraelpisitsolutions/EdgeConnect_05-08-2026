<!--
File:        docs/marketing/solution-multi-site-operations-v2.md
...
Version:     v2 (post-review — single headline refinement)
Date:        2026-05-24

Change from v1 (single surgical edit only):
  - §3 paragraph 3 headline: "Per-gateway identity, established at first
    start." → "Persistent site identity across the fleet."
    Body keeps the UUID/binding technical detail; headline now reads more
    strategically for first-touch executive readers. Visual note in §3
    updated to match.

§4 was deliberately NOT trimmed despite ChatGPT marking it as "maybe."
Per the v1 review for this audience specifically: "all 14 bullets in §4
genuinely earn their place. The density here contributes to enterprise
plausibility." Trimming risks reducing perceived maturity for corporate
ops directors evaluating operating-model completeness.

Per ChatGPT v1 review: v2 is final — freeze and hand to design.
...
# Multi-Site Operations — Solution Page Copy v2 (final)
...
>
> **Persistent site identity across the fleet.** Each EdgeConnect carries a stable UUID and customer/site binding established at first start. Plant A's data is unambiguously Plant A's data. Acquisitions, divestitures, plant renames, regional reorganizations — the identity model survives all of them.
>
...
- **The "Persistent site identity" paragraph deserves slight visual prominence** — it's the unique architectural promise corporate ops directors don't realize they need until they encounter it. The headline reads strategically; the body delivers the architectural detail (UUID + customer/site binding).
...
Density unchanged from v1 — the v2 refinement is a single headline edit, not a content trim.
...
*Solution page — Multi-Site Operations, v2 (final), 2026-05-24. Per ChatGPT v1 review, no v3 planned. Two solution pages remaining: precision manufacturing, OEM machine monitoring.*
