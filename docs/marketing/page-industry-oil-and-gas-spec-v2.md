<!--
File:        docs/marketing/page-industry-oil-and-gas-spec-v2.md
...
Date:        2026-06-06
Status:      LOCKED. Sibling vertical instance of the LOCKED IndustryShell shape.

v1 (page-industry-oil-and-gas-spec-v1.md) retained as historical reference.

v1 -> v2 change (ChatGPT Pass-1 cleanup):
  - §3.6 Q3 (hazardous-area FAQ): "validated per deployment" -> "assessed
    per deployment" (avoids any certification/validation connotation; the
    framing stays IP-rating compatibility, case-by-case during BOM/scoping,
    NO ATEX/IECEx/Ex/Class-Div/intrinsically-safe claim).
...
# `/industries/oil-and-gas` — Page Spec v2 (LOCKED)
...
- [x] ChatGPT Pass 1 review applied; §3.6 Q3 "validated per deployment" → "assessed per deployment"; v2 LOCKED
