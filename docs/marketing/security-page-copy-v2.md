<!--
File:        docs/marketing/security-page-copy-v2.md
...
Version:     v2 (post-review — single language swap)
Date:        2026-05-24

Change from v1 (single surgical edit only):
  - §3 paragraph 1: "rate-limited" → "externally unavailable"
    (more OT-native vocabulary; less SaaS-specific)

Forward-looking notes about vulnerability disclosure, incident response,
backup/recovery integrity, and supply chain security were DELIBERATELY
NOT added in v2. Per ChatGPT review: "the page's biggest strength is
architectural confidence without roadmap leakage. Adding future-state
language risks weakening certainty, increasing perceived incompleteness,
or inviting unnecessary procurement follow-up questions."

Those will become their own separate deliverables (full vulnerability
disclosure policy page, incident response process documentation, etc.)
once the underlying operational programs actually exist.

Per ChatGPT v1 review: no v3 planned — freeze the page and hand to design.
...
# Security and Operational Trust — Page Copy v2 (final)
...
- **Vulnerability disclosure policy detail** — becomes its own page once the program exists
- **Incident response process documentation** — becomes its own page once the program exists
- **Backup / recovery integrity validation documentation** — becomes its own page once the program exists
- **Supply chain security guarantees** — becomes its own statement once the program exists

The deliberate absence of forward-looking notes about those programs is itself a choice — per ChatGPT v1 review, *"adding future-state language risks weakening certainty, increasing perceived incompleteness, or inviting unnecessary procurement follow-up questions."* The page commits to what the platform does today.
...
*Security and Operational Trust — Page Copy v2 (final), 2026-05-24. Per ChatGPT v1 review, no v3 planned — freeze and hand to design. Establishes "operational trust" as a category concept for industrial software trust positioning.*
