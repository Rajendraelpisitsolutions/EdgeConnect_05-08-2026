"""
File:     docs/marketing/assets/build-pitch-deck-v2.py
Purpose:  Generate the executive pitch deck (pitch-deck-v2.pptx) for the
...
Output:   docs/marketing/assets/pitch-deck-v2.pptx

v1 -> v2 refinements (post ChatGPT review pass, 2026-05-24):
  ...
  Slide 7  - "COMING" roadmap line visually subordinated (smaller, darker
             grey, more breathing room above) so roadmap items don't
             visually compete with shipped items.
  Slide 11 - Checkbox items per edition reduced from 4 to 3 (less density).
             More whitespace between editions and roadmap. Roadmap pills
             quieter (smaller, more muted color). RECOMMENDED ribbon
             slightly toned down.

v1 retained as historical reference: build-pitch-deck-v1.py + pitch-deck-v1.pptx

Run:      python docs/marketing/assets/build-pitch-deck-v2.py
"""
...
OUT_PPTX = ASSETS_DIR / "pitch-deck-v2.pptx"
