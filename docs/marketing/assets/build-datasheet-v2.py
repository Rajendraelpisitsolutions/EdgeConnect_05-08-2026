"""
File:     docs/marketing/assets/build-datasheet-v2.py
...
Outputs:
          docs/marketing/assets/datasheet-v2-a4.pdf       (210x297 mm)
          docs/marketing/assets/datasheet-v2-letter.pdf   (8.5x11 in)
...
v1 -> v2 refinements (post first-review pass, 2026-05-24):
  Page 2  Architecture diagram enlarged ~10% by using a narrower
          horizontal margin (10mm vs the standard 18mm) for the image
          only. The diagram now feels more central without crowding —
          page 2 had clear breathing room, this redistributes it
          toward the visual that carries the page.
  Page 4  WHY ELPIS breathing room expanded: differentiator row
          spacing 30 -> 36 pt, more gap above the section, more gap
          between WHY ELPIS and EDITIONS. Soaks up the empty band that
          was sitting between editions and the NEXT STEP CTA.

v1 retained as historical reference (build-datasheet-v1.py +
datasheet-v1-{a4,letter}.pdf). v2 is the new canonical.

Run:      python docs/marketing/assets/build-datasheet-v2.py
"""
...
OUT_A4     = ASSETS / "datasheet-v2-a4.pdf"
OUT_LETTER = ASSETS / "datasheet-v2-letter.pdf"
