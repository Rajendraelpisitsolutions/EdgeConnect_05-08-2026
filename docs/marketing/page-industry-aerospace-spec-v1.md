<!--
File:        docs/marketing/page-industry-aerospace-spec-v1.md
...
Version:     v1 — DRAFT for Pass 1 ChatGPT review (extra anchor-handling scrutiny).
Date:        2026-06-06
Status:      DRAFT. IndustryShell INSTANCE; not a shape-setter. This spec is
...
# `/industries/aerospace` — Page Spec v1 (DRAFT)

> **⚠️ SUPERSEDED — retained as historical reference.** The LOCKED spec is **`page-industry-aerospace-spec-v2.md`** (Pass-1 edit: deleted the §3.5 governance-note parenthetical elaborating the space-agency anchor as "VAS on precision rotating equipment").
...
## 8. Sign-off checklist (v1 DRAFT — for ChatGPT Pass 1, extra anchor scrutiny)
...
- [ ] ChatGPT Pass 1 review (extra anchor-handling + regulated-buyer-tone attention per shape §10.3) — PENDING → v2 lock
