...
public sealed class RuntimeReloadCoordinator : IAsyncDisposable
{
    ...
    private async Task ReconcileAsync(ConfigurationChangeEventArgs e)
    {
        ...
        var effectiveActions = rebindCascade.Count == 0
            ? withRecovery
        ...
        // (the coordinator ↔ driver dance) is a deferred K2 follow-up.
        var rejectedReplaySinkReplacements = ComputeRejectedReplaySinkHotReplacements(effectiveActions);
