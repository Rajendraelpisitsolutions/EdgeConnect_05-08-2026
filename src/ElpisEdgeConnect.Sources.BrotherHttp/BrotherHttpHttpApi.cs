...
internal sealed class BrotherHttpHttpApi : IBrotherHttpApi
{
    ...
    /// <param name="baseUrl">Base URL of the Brother CNC's HTTP interface, e.g. <c>http://192.168.2.110</c>. Trailing slash optional.</param>
    ...
    /// <exception cref="ArgumentException"><paramref name="baseUrl"/> is empty, whitespace, or not a valid absolute URI; or <paramref name="timeoutSeconds"/> is non-positive.</exception>
