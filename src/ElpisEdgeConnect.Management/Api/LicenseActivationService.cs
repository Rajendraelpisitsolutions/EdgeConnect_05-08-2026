...
public sealed record LicenseStatusDto
{
    ...
    /// <summary>Whether the UI should show the Activate License feature.</summary>
    public required bool ShowActivate { get; init; }

    /// <summary>Whether the UI should show the Buy License feature.</summary>
...
public sealed class LicenseActivationService
{
    ...
    public LicenseStatusDto GetStatus()
    {
        ...
        return new LicenseStatusDto
        {
            ...
            ShowActivate = !isValid,
            ShowBuy = status is LicenseStatus.NotLoaded or LicenseStatus.Invalid,
            BuyUrl = _buyUrl,
            ...
            ClockTampered = _trialState.ClockTampered,
        };
    }
