...
public sealed record MelsecSourceConfiguration : SourceConfiguration
{
    ...
    /// <summary>Reset timeout after which the breaker probes (HalfOpen).</summary>
    public int CircuitBreakerResetMs { get; init; } = 30_000;
    ...
    public static MelsecSourceConfiguration FromSourceInstance(SourceInstanceConfig instance)
    {
        ...
        return new MelsecSourceConfiguration
        {
            ...
            CircuitBreakerResetMs = ReadInt(conn, MelsecConnectionKeys.CircuitBreakerResetMs, defaultValue: 30_000),
